...
class Create_Rotation_Trim_Tool(Toplevel):

    def __init__(self, ImageFile, Root):
        super(Create_Rotation_Trim_Tool, self).__init__()
    ...
    def close_window(self):
        self.root.trim_topx = self.topx
        self.root.trim_topy = self.topy
        self.root.trim_botx = self.botx
        self.root.trim_boty = self.boty
        self.root.trim_bool = True
        self.root.DrawLine()
